...
const enrollIntoCourse = async (
  ...
  if (!semesterRegistration) {
    throw new ApiError(httpStatus.NOT_FOUND, 'Semester registraton not found');
  }
  ...
  await prisma.$transaction(async transectionClient => {
    await transectionClient.studentSemesterRegistrationCourse.create({
      data: {
...
const withdrawFromCourse = async (
  ...
  await prisma.$transaction(async transectionClient => {
    await transectionClient.studentSemesterRegistrationCourse.delete({
      where: {
